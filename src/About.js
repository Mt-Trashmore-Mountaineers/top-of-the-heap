    ...
    render() {
        return (
            <div className="main-container">
                ...
                <h2>Jordan Lindo</h2>
                <p>Jordan is a software developer with experience on both large and small development teams building projects with different scopes and timelines. he obtained an Associates degree in software development from Kirkwood Community College, along with certificates in Java and .Net Programming. He rose as far as effort could take him in his position as an auditor. As a supervisor he led small teams and acted as the point of contact for clients. When his scrum team asked him to take over he became the leader of their scrum meetings. He facilitated interaction between scrum teams with a goal of efficient communication and effective results. When he encounter a complex problem he takes time to think through a path that will reach the necessary conclusion.<img src={require('./images/jordanLindoPFP.jpg')}alt='Profile for Jordan Lindo'></img></p>
                <h2>Daniel Frey</h2>
